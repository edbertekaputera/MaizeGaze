			...
			<Modal className="" show={state} onClose={() => setState(false)} popup>
				...
				<Modal.Body>
					<div className="px-7 pt-7 flex flex-col justify-center items-center">
						...
						<Button className="bg-custom-brown-1 text-white w-1/2 mt-5 mx-auto" onClick={() => setState(false)}>
							Keep Plan
						</Button>
						<Button className="bg-red-500 text-white w-1/2 mt-5 mx-auto" onClick={handleCancellation}>
							Confirm Cancel Plan
						</Button>
					</div>
				</Modal.Body>
